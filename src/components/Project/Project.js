        ...
        <>
            ...
            {/* <div className="project">
                ...
                <div className="project-list__conteiner">
                    ...
                    <div className="project__link-conteiner">
                        ...
                        <a target="_blank" className="project__link" href="https://sandhani1704.github.io/russian-travel/">
                            See Live
                        </a>
                    </div>
                </div>
            ...
            <div className="project">
                ...
                <div className="project-list__conteiner">
                    <p className="project__description">The project was created using Create React App.
                        An interactive page where you can add photos, delete them, and like.</p>
                    <div className="project__link-conteiner">
                        <a href="https://github.com/Sandhani1704/mesto-react" target="_blank" rel="noopener noreferrer" className="project__link">Github</a>
                        <a target="_blank" className="project__link" href="https://sandhani1704.github.io/mesto-react/">
                            See Live
                        </a>
                    </div>
                </div>
            ...
            <div className="project">
                ...
                <div className="project-list__conteiner">
                    ...
                    <div className="project__link-conteiner">
                        <a href="https://github.com/Sandhani1704/express-mesto" target="_blank" rel="noopener noreferrer" className="project__link">Github</a>
                        <a target="_blank" className="project__link" href="#">
                            See Live
                        </a>
                    </div>
                </div>
            ...
            <div className="project">
                ...
                <div className="project-list__conteiner">
                    ...
                    <div className="project__link-conteiner">
                        ...
                        <a target="_blank" className="project__link" href="https://sandhani1704.github.io/react-mesto-auth/">
                            See Live
                        </a>
                    </div>
                </div>
